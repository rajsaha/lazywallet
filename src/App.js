...
function App() {
  ...
  async function login({ username, password }) {
    ...
    const _result_login = await axios.post(
  ...
  async function signup({ email, username, password }) {
    ...
    const _result_signup = await axios.post(
        ...
        <div className={`app ${appTheme}`}>
          <div className="content-container">
            ...
            <ProtectedRoute
              path="/account"
              component={() => (
                <Account currentTheme={appTheme} logoutCallback={logout} />
              )}
            />
            <Route
              path="/login"
              component={() => <Login loginCallback={login} />}
            ></Route>
            <Route
              path="/signup"
              component={() => <Signup signupCallback={signup} />}
            ></Route>
          </div>
          {token ? <PrimaryNav /> : ""}
